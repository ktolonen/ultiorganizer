...
Configuration: [`phpstan.neon.dist`](../phpstan.neon.dist). Currently at level 4; existing findings are captured in [`phpstan-baseline.neon`](../phpstan-baseline.neon) so they do not block work. New code must analyse cleanly.
