...
if (isset($_POST['upload'])) {
    ...
    if (empty($_POST['series'])) {
        ...
        $req_validity = empty($_POST['validity']) ? [] : $_POST['validity'];
        $req_type = empty($_POST['type']) ? [] : $_POST['type'];
...
function slklUpdateLicensesFromCSV($handle, $season)
{
    ...
    while (($data = fgetcsv($handle, $length, $delimiter)) !== false) {
        ...
        $valid_membership = [3968, 3972,4676,4678,4653,4664];
        $valid_license = [3970, 3971, 3974, 3975, 4076, 4077, 4078, 4303, 4304, 4302, 4305, 4677, 4679, 4680, 4681, 4593,4659,4660,4663,4662,4655,4654,4656,4661,4665];
        $valid_juniors = [3974, 3975, 4077, 4304, 4305, 4680, 4681,4663,4662,4665];
        $ignore = [];
