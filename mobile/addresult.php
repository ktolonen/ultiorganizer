...
$html .= "</td></tr><tr><td>\n";
$html .= "<input class='input' name='home' value='" . intval($result['homescore']) . "' inputmode='numeric' pattern='[0-9]*' maxlength='3' size='5'/>";
$html .= " - ";
$html .= "<input class='input' name='away' value='" . intval($result['visitorscore']) . "' inputmode='numeric' pattern='[0-9]*' maxlength='3' size='5'/>";
$html .= "</td></tr><tr><td>\n";
$html .= "</td></tr><tr><td>\n";
