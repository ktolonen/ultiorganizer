...
$html .= "</td></tr><tr><td>\n";
$html .= "<input class='input' id='pass' name='pass' maxlength='3' size='3' value='".$pass."'/> ". _("Assist");
$html .= "</td></tr><tr><td>\n";
$html .= "<input class='input' id='goal' name='goal' maxlength='3' size='3' value='".$goal."'/> ". _("Goal");
$html .= "</td></tr><tr><td>\n";
