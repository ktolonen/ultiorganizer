...
class EventDataXMLHandler
{
    ...
    public $uo_season = []; //event id mapping array
    public $uo_series = []; //series id mapping array
    public $uo_team = []; //team id mapping array
    public $uo_scheduling_name = []; //scheduling id mapping array
    public $uo_pool = []; //pool id mapping array
    public $uo_player = []; //player id mapping array
    ...
    public function EventToXML($eventId)
    {
     ...
     */
    public function RowToXML($elementName, $row, $endtag = true)
    {
     ...
     */
    public function ReplaceInDatabase($name, $row)
    {
